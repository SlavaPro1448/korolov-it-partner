          ...
          <div className="space-y-10 text-foreground/90 leading-relaxed">
            <section className="rounded-lg border border-border bg-section p-5">
              <p className="text-sm">
                ...
                <strong>Verbraucher im Sinne von § 13 BGB</strong>, d. h. natürliche Personen, die ein Rechtsgeschäft zu
                überwiegend privaten Zwecken abschließen. Für Unternehmer (§ 14 BGB) besteht kein gesetzliches
                Widerrufsrecht.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">Die Widerrufsfrist beträgt vierzehn Tage ab dem Tag des Vertragsabschlusses.</p>
            ...
            <section>
              ...
              <p>
                ...
                Mitteilung über Ihren Widerruf dieses Vertrags bei mir eingegangen ist.
              </p>
              <p className="mt-3">
                Für diese Rückzahlung verwende ich dasselbe Zahlungsmittel, das Sie bei der ursprünglichen Transaktion
              ...
              <p className="mt-3">
                ...
                mir einen angemessenen Betrag zu zahlen, der dem Anteil der bis zu dem Zeitpunkt, zu dem Sie mich von der
            ...
            <section>
              <h2 className="text-lg font-semibold text-brand mb-3">Erlöschen des Widerrufsrechts</h2>
              <p>
                Das Widerrufsrecht erlischt bei einem Vertrag zur Erbringung von Dienstleistungen auch, wenn ich die
                Dienstleistung vollständig erbracht habe und mit der Ausführung der Dienstleistung erst begonnen habe,
                nachdem Sie dazu Ihre ausdrückliche Zustimmung gegeben und gleichzeitig Ihre Kenntnis davon bestätigt
                haben, dass Sie Ihr Widerrufsrecht bei vollständiger Vertragserfüllung durch mich verlieren (§ 356 Abs. 4
                BGB).
              </p>
            </section>
