...
export const de: Dict = {
  ...
  about: {
    ...
    paragraphs: [
      "Mein Name ist {name}. Mit Korolov IT-Service unterstütze ich kleine Unternehmen, Selbstständige und lokale Dienstleister in Leverkusen, Köln und NRW bei Websites, geschäftlicher E-Mail, IT-Fragen und digitaler Organisation.",
      "Mein Ziel ist es, technische Themen verständlich und praktisch zu lösen. Viele Unternehmen brauchen keine große Agentur, sondern einen zuverlässigen Ansprechpartner, der erklärt, umsetzt und auch nach dem Projekt erreichbar bleibt.",
    ],
    trust: [
    ...
    cardRole: "Inhaber · Korolov IT-Service",
    cardLocation: "Leverkusen, NRW",
    cardLanguages: "Deutsch · Русский · Українська",
    cardContactNote: "Direkter Ansprechpartner",
  },
  problem: {
    headingPrefix: "Viele kleine Unternehmen brauchen keine große Agentur — sondern ",
    headingHighlight: "zuverlässige technische Unterstützung",
    headingSuffix: ".",
    description:
      "Website veraltet, E-Mail-Probleme, Kontaktformulare funktionieren nicht, Updates bleiben liegen oder niemand fühlt sich für die Technik verantwortlich. Genau hier unterstütze ich: praktisch, verständlich und mit Blick auf den Alltag Ihres Unternehmens.",
    items: [
      {
